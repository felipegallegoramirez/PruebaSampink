          ...
          {activeTab === "hallazgos" && (
            <div className="tab-content">
              ...
              {/* --- Hallazgos Detallados --- */}
               ...
               <CollapsibleSection title="Antecedentes Procuraduría" defaultOpen={(person?.procuraduria?.length ?? 0) > 0}>
                    {(person?.procuraduria?.length ?? 0) > 0 ? (
                                ...
                                <div key={`proc-${index}`} className="finding-item">
                                    ...
                                    {(antecedente?.datos ?? []).map((dato, datoIndex) => (
                                        <div key={`proc-dato-${datoIndex}`} style={{ marginLeft: '10px', marginBottom: '15px' }}>
                                            ...
                                            {dato?.Sanciones && dato.Sanciones.length > 0 && (
                                                <>
                                                <h5>Sanciones:</h5>
                                             ...
                                             {dato?.Instancias && dato.Instancias.length > 0 && (
                                                <>
                                                <h5>Instancias:</h5>
