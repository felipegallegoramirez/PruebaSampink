  ...
  return (
    <div className="person-report-container" ref={reportContainerRef} id="person-report-content">
        ...
        <div className="report-body">
            ...
            <CollapsibleSection title="Información PEP" defaultOpen={shouldOpen(person?.cidob)}>
              {person?.cidob ? (
            ...
            <CollapsibleSection title="Información Reputacional" defaultOpen={shouldOpen(person?.reputacional)}>
             ...
             <CollapsibleSection title="Información Tránsito (RUNT, SIMIT, etc.)" defaultOpen={shouldOpen(person?.runt_app) || shouldOpen(person?.simit) || shouldOpen(person?.simur)}>
                {person?.runt_app ? (
                  <>
                    <h4>RUNT</h4>
